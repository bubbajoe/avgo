...
var tmpl = `// Code generated by avgo. DO NOT EDIT.
package avgo
{{ range $val := . }}
...
var tmplTest = `// Code generated by avgo. DO NOT EDIT.
package avgo_test
import (
	"testing"
...
func Test{{ $val.Name }}Flags{{ $val.Suffix }}(t *testing.T) {
	fs := avgo.New{{ $val.Name }}Flags{{ $val.Suffix }}(avgo.{{ $val.Name }}Flag{{ $val.Suffix }}(1))
	require.True(t, fs.Has(avgo.{{ $val.Name }}Flag{{ $val.Suffix }}(1)))
	fs = fs.Add(avgo.{{ $val.Name }}Flag{{ $val.Suffix }}(2))
	require.True(t, fs.Has(avgo.{{ $val.Name }}Flag{{ $val.Suffix }}(2)))
	fs = fs.Del(avgo.{{ $val.Name }}Flag{{ $val.Suffix }}(2))
	require.False(t, fs.Has(avgo.{{ $val.Name }}Flag{{ $val.Suffix }}(2)))
}
{{ end }}`
